...
class CommonJsonTypesSpec extends PlaySpec  {

//  "JsonValidator" must {
//    //Happy Path
//    "read the schema and return a SuccessfulValidation" when {
//      "given a valid correspondence Address" in {
//        val result = schemaValidator.validateAgainstSchema(validCorrespondenceAddress, "/definitions/correspondenceAddressType")
//        result mustBe SuccessfulValidation
//      }
//      "given a valid Company" in {
//
//        val result = schemaValidator.validateAgainstSchema(validCompany, "/definitions/companyType")
//        result mustBe SuccessfulValidation
//
//      }
//    }
