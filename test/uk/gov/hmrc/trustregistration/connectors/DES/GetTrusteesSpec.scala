  ...
  "Get Trustees endpoint" must {
    ...
    "return a GetSuccessResponse with a populated Trustee list" when {
      ...
      "DES returns a 200 response with a JSON array of Trustees containing an Address with none of the optional parameters" in {
        val jsonReturn = """[{"givenName":"Juan","familyName":"Doe","dateOfBirth" : "2012-04-23T18:25:43.511Z", "correspondenceAddress" : {"line1" : "123 Any Street"}}]"""
        when (mockHttpGet.GET[HttpResponse](Matchers.any())(Matchers.any(),Matchers.any())).thenReturn(Future.successful(HttpResponse(200, Some(Json.parse(jsonReturn)))))
        val result = Await.result(SUT.getTrustees("1234"),Duration.Inf)
        result mustBe GetSuccessResponse(List(Individual("Juan","Doe",new DateTime("2012-04-23T18:25:43.511Z"),None,None,None,None,None,Some(Address("123 Any Street")))))
      }

      "DES returns a 200 response with a JSON array of Trustees containing an Address with some of the optional parameters" in {
        val jsonReturn = """[{"givenName":"Juan","familyName":"Doe","dateOfBirth" : "2012-04-23T18:25:43.511Z", "correspondenceAddress" : {"line1" : "123 Any Street","line2" : "Mowr Town","postalCode" : "NE21 25A"}}]"""
        when (mockHttpGet.GET[HttpResponse](Matchers.any())(Matchers.any(),Matchers.any())).thenReturn(Future.successful(HttpResponse(200, Some(Json.parse(jsonReturn)))))
        val result = Await.result(SUT.getTrustees("1234"),Duration.Inf)
        result mustBe GetSuccessResponse(List(Individual("Juan","Doe",new DateTime("2012-04-23T18:25:43.511Z"),None,None,None,None,None,Some(Address("123 Any Street",Some("Mowr Town"),None,None,Some("NE21 25A"))))))
      }

      "DES returns a 200 response with a JSON array of Trustees containing an Address with all the optional parameters" in {
        val jsonReturn = """[{"givenName":"Juan","familyName":"Doe","dateOfBirth" : "2012-04-23T18:25:43.511Z", "correspondenceAddress" : {"line1" : "123 Any Street","line2" : "Mowr Town","line3" : "Test","line4" : "Test Test Test 523125223","postalCode" : "NE21 25A","country" : "ZAR"}}]"""
        when (mockHttpGet.GET[HttpResponse](Matchers.any())(Matchers.any(),Matchers.any())).thenReturn(Future.successful(HttpResponse(200, Some(Json.parse(jsonReturn)))))
        val result = Await.result(SUT.getTrustees("1234"),Duration.Inf)
        result mustBe GetSuccessResponse(List(Individual("Juan","Doe",new DateTime("2012-04-23T18:25:43.511Z"),None,None,None,None,None,Some(Address("123 Any Street",Some("Mowr Town"),Some("Test"),Some("Test Test Test 523125223"),Some("NE21 25A"),None)))))
      }

      "DES returns a 200 response with a JSON array of Trustees containing an Address and Passport" in {
        val jsonReturn = """[{"givenName":"Juan","familyName":"Doe","dateOfBirth" : "2012-04-23T18:25:43.511Z","passport":{"identifier" : "AA12345","expiryDate" : "2012-04-23T18:25:43.511Z","countryOfIssue" : "ESP"}, "correspondenceAddress" : {"line1" : "123 Any Street","line2" : "Mowr Town","line3" : "Test","line4" : "Test Test Test 523125223","postalCode" : "NE21 25A","country" : "ZAR"}}]"""
        when (mockHttpGet.GET[HttpResponse](Matchers.any())(Matchers.any(),Matchers.any())).thenReturn(Future.successful(HttpResponse(200, Some(Json.parse(jsonReturn)))))
        val result = Await.result(SUT.getTrustees("1234"),Duration.Inf)
        val expectedPassport = Passport("AA12345", new DateTime("2012-04-23T18:25:43.511Z"), "ESP")
        result mustBe GetSuccessResponse(List(Individual("Juan","Doe",new DateTime("2012-04-23T18:25:43.511Z"),None,None,None,None,Some(expectedPassport),Some(Address("123 Any Street",Some("Mowr Town"),Some("Test"),Some("Test Test Test 523125223"),Some("NE21 25A"),None)))))
      }
