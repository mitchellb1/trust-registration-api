...
case class DesPersonalRepresentative(name: DesName, dateOfBirth: DateTime, identification: DesIdentification, phoneNumber: Option[String] = None, email: Option[String] = None)
